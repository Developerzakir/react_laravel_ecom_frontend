          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3">
                ...
                <div className='pt-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, perferendis.</div>
              </div>
              <div className="col-md-3">
                <h3>Categories</h3>
                <ul>
            ...
            <div className="row py-3 spotlight">
              <div className="col-md-4">
                <div className="d-flex justify-content-center">
                  ...
                  <h4 className='ps-2'>Free Delivery</h4>
                </div>
              </div>
              <div className="col-md-4">
              <div className="d-flex justify-content-center">
                ...
                <h4  className='ps-2'>Money Back Guarantee</h4>
              </div>
              </div>
              <div className="col-md-4">
              <div className="d-flex justify-content-center">
                ...
                <h4  className='ps-2'>Secure Payment</h4>
              </div>
              </div>
            </div>
